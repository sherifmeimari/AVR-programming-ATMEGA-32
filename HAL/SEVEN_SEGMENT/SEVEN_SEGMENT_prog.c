...
void SEVEN_SEGMENT_ENABLE(SEVEN_SEGMENT_NUM) {
	...
	switch(SEVEN_SEGMENT_NUM) {
		...
		case SEVEN_SEGMENT_0:
				...
				DIO_u8SetPin(SEVEN_SEGMENT_EN_0_PIN, DIO_LOW);
			}
		...
		case SEVEN_SEGMENT_1:
				...
				DIO_u8SetPin(SEVEN_SEGMENT_EN_1_PIN, DIO_LOW);
			}
...
void SEVEN_SEGMENT_DISPLAY(u8 SEVEN_SEGMENT_NUM, u8 data) {
	...
	if(data >= 0 && data <= 9) {
		...
		switch(data) {
			...
			case 0;
				DIO_u8SetPin(SEVEN_SEGMENT_A_PIN, DIO_LOW);
				DIO_u8SetPin(SEVEN_SEGMENT_B_PIN, DIO_LOW);
				DIO_u8SetPin(SEVEN_SEGMENT_C_PIN, DIO_LOW);
				DIO_u8SetPin(SEVEN_SEGMENT_D_PIN, DIO_LOW);
				break;
			case 1;
